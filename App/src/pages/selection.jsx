...
function Selection({ onSignupClick, onLoginClick}) {
  ...
  return (
    <div className='flex flex-col justify-center items-center h-screen bg-slate-700'>
      <button className='font-mono transition-all text-5xl border-2 rounded-md border-black bg-green-300 hover:bg-green-500 active:bg-green-600 m-3 px-3 py-1' onClick={onSignupClick}>Sign up (Test7)</button>
